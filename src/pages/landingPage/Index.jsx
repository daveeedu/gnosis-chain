...
import { ILightningBolt, IMobileBG, ITalentOne, ITalentTwo, ITalentThree, ITwitter, ILinkedIn, IInstagram, IGithub } from '../../utils/icons.utils'
import CardComp from '../../components/CardComp';

const LandingPage = () => {
    const cards = [
        { id: 1, title: 'David Edu', img: ITalentOne, profession: 'Software Engineer | Web3 Solidity developer', content: 'Your staff payroll history is kept in one place forever. No more excel sheet or manual records. Download your payroll history anytime you need it.', links: {
        ...
        { id: 2, title: 'Rukayat Olorireomo', img: ITalentTwo, profession: 'Software Engineer | FrontEnd developer', content: 'Wherever you are Eazipay has got you covered on ALL your Payroll tasks. Whether it is Taxes, Pension insurances HMOs, trustfunds, ', links: {
            github: '',
            linkedin: '',
            twitter: '',
            instagram: ''
    ...
    return (
        <div>
            <div className='logo-container flex px-10'>
